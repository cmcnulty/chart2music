...
const dictionary: translationDict = {
    ...
    "point-xy-stack": "{x}, {y}, répartition: {stackBreakdownFormatted}",
    "point-xy-label-stack":
        "{announcePointLabelFirst, select, true {{label}, {x}, {y}, répartition: {stackBreakdownFormatted}} other {{x}, {y}, {label}, répartition: {stackBreakdownFormatted}}}",
