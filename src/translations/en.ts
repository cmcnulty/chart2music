...
const dictionary: translationDict = {
    ...
    "point-xy-stack": "{x}, {y}, breakdown: {stackBreakdownFormatted}",
    "point-xy-label-stack":
        "{announcePointLabelFirst, select, true {{label}, {x}, {y}, breakdown: {stackBreakdownFormatted}} other {{x}, {y}, {label}, breakdown: {stackBreakdownFormatted}}}",
